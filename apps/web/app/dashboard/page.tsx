    ...
    <div className="min-h-screen flex flex-col bg-[#F4F2E8]">
      ...
      <nav className="bg-[#B4E1FF] px-8 py-1.5 flex items-center justify-between shrink-0">
        <div className="flex items-center gap-3">
          ...
          <span className="text-[#241715] text-[30px] font-medium tracking-wide">
            Student Life Helper
          </span>
        </div>

        <div className="flex items-center gap-3">
          <span className="text-[#241715]/70 text-[13px] hidden sm:block">{fullName}</span>
          <div className="w-8 h-8 rounded-full bg-[#6A9879] flex items-center justify-center">
            <span className="text-white text-xs font-semibold">{fullName[0]}</span>
          </div>
        </div>
      </nav>
